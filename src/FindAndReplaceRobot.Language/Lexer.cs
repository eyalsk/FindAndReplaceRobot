    ...
    public sealed class Lexer
    {
        ...
        private Token LexIdentifier()
        {
            ...
            while (true)
            {
                ...
                if (IsNewLineOrEOF(ch) || !IsIdentifier(ch))
                {
                    var kind = IsNewLineOrEOF(ch) ? TokenKind.Identifier : TokenKind.Error;
        ...
        private static bool IsIdentifier(char ch) => char.IsLetterOrDigit(ch);
    }
}
