    ...
    internal class TokenTests
    {
        ...
        public void Should_throw_when_start_below_zero()
        {
            Should.Throw<ArgumentOutOfRangeException>(() =>
                new Token(start: -1, end: 0, kind: TokenKind.None, value: ReadOnlyMemory<char>.Empty));
        }
        ...
        {
            Should.NotThrow(() =>
                new Token(start: 0, end, kind: TokenKind.None, value: ReadOnlyMemory<char>.Empty));
        }
        ...
        {
            Should.Throw<ArgumentOutOfRangeException>(() =>
                new Token(start: 1, end, kind: TokenKind.None, value: ReadOnlyMemory<char>.Empty));
        }
        ...
        {
            Should.NotThrow(() =>
                new Token(start: 0, end: 0, kind: TokenKind.None, value: ReadOnlyMemory<char>.Empty));
        }
        ...
        public void Should_throw_when_kind_is_undefined()
        {
            Should.Throw<ArgumentException>(() =>
                new Token(start: 0, end: 0, kind: (TokenKind)int.MinValue, value: ReadOnlyMemory<char>.Empty));
        }
    }
}